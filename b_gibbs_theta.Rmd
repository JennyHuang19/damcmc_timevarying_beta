...
## Testing
# Plotting an example gamma density
```{r}
...
```{r}
# the extremely large b relative to a creates very small variance. Hence, the proposal variance for beta* is small. In the case when Z is fixed, the chain converges to the true value very quickly (Gibbs sampling step).
# the prior hyperparameters are barely at play, as data-driven components, nt and int(st, it), are much larger.
