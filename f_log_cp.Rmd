...
# f_log is one portion of the likelihood on which beta is constant. Calculate the complete data likelihood by summing f_logs together,
...
#' @export
#'
f_log_cp <- function(theta, SS, gener, b, iota_dist = "exponential") { # QUESTION: why is f_log returning 0?
