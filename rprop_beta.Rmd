...
# draw from initial (dbeta)
```{r}
h_hat <- c(0.1, 0.1, 0.75, 0.1, 0.1)
dbeta <- rbern(5, h_hat)
```

Note: Each vector component in beta_star and beta represents a time unit (e.g. week)
...
# if we would like to flip according to a prior probability vector, we can do that is is_prob = TRUE.
#if(is_prop){
