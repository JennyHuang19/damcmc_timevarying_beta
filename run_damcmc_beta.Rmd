...
```{r}
#' Run a DA-MCMC to infer beta and delta_beta (dbeta) vectors, keeping latent data Z constant.
#'
#' @inheritParams experiment_1_proof_of_concept
#' @param x complete data
#' @param Y observed data
#' @param N number of MCMC iterations
#' @param rho proportion of the latent data updated each iteration
#' @param param parameterization: "bg" indicates (beta,gamma)
...
#' @param iota_dist parameterization: "bg" indicates (beta,gamma)
...
#' @return list with the draws for the parameters, the log likelihood, and acceptance rate
#' @export
#'
