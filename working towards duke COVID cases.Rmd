...
How can we tell if the curve flattens because of a change in transmission rate (i.e. lockdowns, mask mandates) or because of the natural trajectory of the I(t) curve (i.e. depletion of the S(t) compartment)?
